 ...
 * I've also added a couple of subclasses of Model to represent model that are commonly used in state space control, those being
 ...
 * x := [cart_position, cart_velocity, stick_angle, stick_angular_rate]^T
 *
 * And it is assumed that 1: the controller manipulates the voltage supplied to the motor and 2: the motor position, velocity and current are all directly measureable meaning that the system has full state feedback
 *
 * To parameterise the system the following physical measurements are required:
 *
